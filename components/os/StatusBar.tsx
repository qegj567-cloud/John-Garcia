...
const StatusBar: React.FC = () => {
  ...
  return (
    <div className="h-10 w-full flex justify-between items-center px-6 text-white text-xs font-semibold z-50 absolute top-0 left-0 bg-transparent">
      <div className="w-1/3">
      ...
      <div className="w-1/3 flex justify-end gap-2 items-center">
        ...
        <div className="flex items-center gap-1">
          ...
          <div className="w-5 h-2.5 border border-white/40 rounded-[2px] p-[1px] relative">
